...
def start_module():
    ...
    async def felix_help(event):
        message = (
            "**Кібер-Фелікс**:\n"
            "**Stealer** - __щоб вкрасти мем, чи арт, введи команду `!steal` у відповідь на медіа, яке хочеш вкрасти, "
            ...
            "__Наприклад, команда `!steal -r Приклад коментаря з тегом #tag`, "
            ...
            "**Примітка**:\n"
            "    -__Щоб вкрасти медіа з дефолтним підписом, але іншим тегом, введи `!steal #tag`.__\n"
            "    -__Можна ввести множину тегів, наприклад `!steal #tag1 tag2`.__\n"
